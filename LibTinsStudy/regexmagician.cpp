...
std::string RegexMagician::findHost(char *payload, int payloadSize, bool &flag)
{
    //set flag to false
    flag=false;
...
std::string RegexMagician::findCookie(char *payload, int payloadSize,bool &flag)
{
    //set flag to false
    flag=false;
